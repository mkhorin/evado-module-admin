...
Object.assign(Jam.I18n.defaults, {
    ...
    'User filter configuration to select recipients when message creating': 'Конфигурация фильтра пользователей для выбора получателей при создании сообщения',
    'User filters to select recipients when notification sending': 'Фильтры пользователей для выбора получателей при отправке сообщения',
